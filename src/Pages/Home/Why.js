      ...
      <div className="d-flex flex-column justify-content-center align-items-center">
        ...
        <div className="bg-primary my-4 p-4">
          <p className="text-light fs-5 py-3 lh-base text-center">
            ...
            Provider (ISP). We are dedicated to ensure high performance and
            secure Internet Connectivity to our customer with our compromising
            the quality of services. Our aim is to spread out Super Fast
            Broadband Internet Connectivity in Bangladesh at minimum cost.
          </p>
        </div>
